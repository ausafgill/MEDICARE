...
class PharmacyOrderDetailScreen extends StatefulWidget {
  static const routeName = '/pharmacy-order-detail';
  const PharmacyOrderDetailScreen({super.key});

  @override
  State<PharmacyOrderDetailScreen> createState() => _OrderDetailScreenState();
}

class _OrderDetailScreenState extends State<PharmacyOrderDetailScreen> {
  @override
