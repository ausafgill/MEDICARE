...
Route<dynamic> generateRoute(RouteSettings settings) {
  switch (settings.name) {
    ...
    case MapDisplayWidget.routeName:
      List<dynamic> args = settings.arguments as List<dynamic>;

      return MaterialPageRoute(
        builder: (context) => MapDisplayWidget(
            latitude: args[0], longitude: args[1], isStatic: args.length == 3),
      );
    ...
    case TransporterScreen.routeName:
      return MaterialPageRoute(
        builder: (context) => const TransporterScreen(),
      );
    ...
    case ChatScreen.routeName:
      ...
      return MaterialPageRoute(
        builder: (context) => ChatScreen(chatRoom: args[0]),
      );
